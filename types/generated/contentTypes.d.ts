...
export interface ApiFeaturedPostFeaturedPost extends Schema.CollectionType {
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    NameOfProduct: Attribute.String & Attribute.Required;
    Listing: Attribute.Component<'product-listing.product-listing', true>;
